...
export const sportsMoments: SportsMoment[] = [
  ...
  },
  {
    ...
    description: "Out of the list, this is the only losing performance from a player and yet Mbappé captured the heart of billions across the world and stabbed the hearts of more. Somehow, someway, after falling 2-0 against Argentina in the World Cup final, Mbappé sinks the penalty before scoring again within 90 seconds, reigniting an entire nation. Often times it's not the losses that people remember, it's just your performance. If all you can control is yourself, then put in 1000% every time.",
  ...
  },
  {
    ...
    description: "This is the only moment here that I was not alive for but given that it's Arizona's only championship of the 4 major American sports, it would be a disservice if I excluded it. Only a few years after their founding, the Diamondbacks find themselves in the World Series against the most storied franchise in baseball history. Led by their all-time great duo of pitchers Randy Johnson and Curt Schilling, the DBacks dominate the Yankeese, but thanks to a couple of blown saves, they find themselves in a Game 7. Randy Johnson, after throwing over a 100 pitches the game before, manages to get Arizona through the top of the 9th. The bases get loadded and Luis Gonzalez floats one into center field to give Arizona it's first championship ever.",
